<script>
    ...
    let title ="Jean-Louis Picard" ;
    let imageSrc = "./src/components/Card/oeuf-smile.svg"
    let shortDescription = "Jean-Louis Picard était un compositeur-interprète américain. Considéré comme le père du rock and roll, il est souvent inclus dans des listes comme les plus grands artistes de tous les temps" ;
